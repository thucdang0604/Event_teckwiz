  ...
  static void _handleNotificationNavigation(NotificationModel notification) {
    ...
    switch (notification.type) {
      ...
      case NotificationType.registrationRejected:
        // Navigate to registrations screen or profile
...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  // Save notification to history even when app is in background
  if (message.notification != null) {
    final notification = NotificationModel(
    ...
    // Save to shared preferences directly since we can't access the in-memory list
    try {
      final prefs = await SharedPreferences.getInstance();
